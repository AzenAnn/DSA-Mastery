import type { CourseDocument } from "./documents.ts";
...
export const curriculumChapterDefinitions: CurriculumChapterDefinition[] = [
  {
    id: "chapter-preface",
    number: "preface",
    label: "前言",
  ...
  },
  {
    ...
    focusTitle: "本章路径",
    focusAreas: ["二叉搜索树、AVL 与局部旋转", "堆、优先队列与赫夫曼编码", "并查集、B 树与 B+ 树"],
    lessonSources: [
  ...
  },
  {
    ...
    lessonSources: [
      ...
      "content/chapter-07-graph-traversal/02-topological-sort.md",
      "content/chapter-07-graph-traversal/03-minimum-spanning-tree.md",
      "content/chapter-07-graph-traversal/04-shortest-path.md",
      "content/chapter-07-graph-traversal/05-astar-visualization.md",
      "content/chapter-07-graph-traversal/06-network-flow-and-matching.md",
    ],
    autoLabChapter: 7,
  },
  {
...
export const curriculumPartDefinitions = [
