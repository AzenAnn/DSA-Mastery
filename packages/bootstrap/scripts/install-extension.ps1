...
try {
    ...
    if (-not (Test-Path -LiteralPath $VsixPath -PathType Leaf)) { throw "VSIX does not exist: $VsixPath. Download a release asset or run pnpm run package in apps/vscode-extension first." }
