...
import { studentSourcePath } from './labIndex';
import type { LabEntry, ProjectLab, ProgramLab } from './labIndex';
...
import { projectProgressPassed, summarizeProjectSubmission } from './projectProgress';
