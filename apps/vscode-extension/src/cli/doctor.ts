import type { LabEntry } from "../labs/discovery";
import type { DoctorResult } from "./client";
import path from "node:path";
import * as vscode from "vscode";
import { CliError, runDoctor } from "./client";
...
async function reportEnvironmentIssues(repoRoot: string, environment: DoctorResult): Promise<void> {
