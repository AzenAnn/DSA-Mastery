 ...
 */
function stripSections(markdown: string, titles = HIDDEN_SECTIONS): string {
...
export async function renderReadme(lab: LabEntry, webview: vscode.Webview): Promise<RenderedReadme> {
  let raw = "";
  try {
