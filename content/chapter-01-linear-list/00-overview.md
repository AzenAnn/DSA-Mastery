...
6. [从数组解法到链表解法——解题模型的迁移](./06-array-to-linked-list-problem-solving.md)
...
[Lab 01-T-06：线性表理论大题训练](../../labs/chapter-01/theory/T-01-06-linear-list-written/README.md)包含 15 道书面综合题，分为有序性与扫描、原地修改与拆分、集合运算与链结构三组。每题附设计思路、伪代码、正确性说明、复杂度分析和评分要点，共 150 分，人工自评。

建议完成基础选择题和第 6 篇解题迁移后，分三次完成这份理论训练，重点检查算法的前提、不变量、失败反例和结点所有权。
...
- [Lab 01-P-02：105 栋的热心同学](../../labs/chapter-01/project/P-01-02-105-dorm/README.md)：从学生名单、体力结算到待送清单，用带提示的学生代码练习顺序表批量删除、扫描求最大值和单链表遍历删除，适合先做基础综合训练。
