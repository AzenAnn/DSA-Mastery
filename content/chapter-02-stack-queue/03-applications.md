...
这里只展示“队列在逐层扩散中的作用”。图的存储、广度优先遍历和最短路径将在[图的遍历](../chapter-07-graph-applications/01-traversal.md)中系统展开。本节的关键收获是：**队列的 FIFO 顺序恰好对应“按层处理”**。
:::
...
- 广度优先遍历的完整图论内容见[图的遍历](../chapter-07-graph-applications/01-traversal.md)。
