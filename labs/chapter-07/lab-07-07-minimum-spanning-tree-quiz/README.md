...
### 1. 我最容易在哪个前提上出错：MST 唯一性、复杂度，还是与最短路径树的区别？

::: details 参考答案
逐项复盘时应写出触发条件：MST 只要求全局连通且总权最小；最短路径树依赖指定源点，保证源点到各点距离最短；复杂度还取决于 Prim 的数据结构和图的稠密程度。把“全局总权”误当成“从源点的距离和”是最常见混淆。
:::

### 2. 哪道题的干扰项最容易混淆？它利用了哪个常见误区？

::: details 参考答案
常见误区包括把“唯一最大边不属于任何 MST”扩大成“并列最大边也不属于任何 MST”，或把边权互异误认为 MST 唯一的必要条件。检查选项时要区分“存在一棵 MST 不选”和“所有 MST 都不选”。
:::
