...
> 题集 T25 · 规划节 7.5。题目来源：改编自 [洛谷 P1379 八数码难题](https://www.luogu.com.cn/problem/P1379)。保留目标 123804765；课程版额外加入无解输入，输出 -1。
...
```powershell
pnpm lab:doctor -- labs/chapter-07/exercise/E-07-28-eight-puzzle
pnpm lab:run -- labs/chapter-07/exercise/E-07-28-eight-puzzle --case 001-sample
pnpm lab:score -- labs/chapter-07/exercise/E-07-28-eight-puzzle
```
