...
```powershell
pnpm lab:doctor -- labs/chapter-07/exercise/E-07-15-minimum-effort-path
pnpm lab:run -- labs/chapter-07/exercise/E-07-15-minimum-effort-path --case 001-sample
