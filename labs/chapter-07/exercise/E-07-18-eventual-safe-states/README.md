...
# Lab 07-E-18：找到最终的安全状态

> 题集 T08 · 规划节 7.2。题目来源：改编自 [LeetCode 802 找到最终的安全状态](https://leetcode.cn/problems/find-eventual-safe-states/)，邻接数组改为边表输入，显式输出答案数量。
...
```powershell
pnpm lab doctor labs/chapter-07/exercise/E-07-18-eventual-safe-states
pnpm lab run labs/chapter-07/exercise/E-07-18-eventual-safe-states --case 001-sample
pnpm lab score labs/chapter-07/exercise/E-07-18-eventual-safe-states
```
