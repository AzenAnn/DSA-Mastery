...
完成 [Lab 07-E-07：Dijkstra 逐轮推演](../E-07-07-dijkstra-trace/README.md)。本题直接应用堆优化 Dijkstra：先求源点到每个节点的最短距离；若全部节点可达，答案就是 $\max_v \mathrm{dist}[v]$，否则输出 `-1`。
...
pnpm lab:score -- labs/chapter-07/exercise/E-07-09-network-delay-time
```
