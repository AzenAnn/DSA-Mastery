...
```powershell
pnpm lab:run -- labs/chapter-11/exercise/E-11-11-min-heap-template
pnpm lab:score -- labs/chapter-11/exercise/E-11-11-min-heap-template
```
