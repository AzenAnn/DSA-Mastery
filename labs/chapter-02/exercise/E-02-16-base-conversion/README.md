---
title: "Lab 02-E-16：栈实现进制转换"
description: "练习栈实现进制转换，强化栈与队列的不变量、边界和复杂度。"
order: 23
chapter: 2
labId: "02E16"
chapterTitle: "栈与队列"
...
掌握栈实现进制转换的栈/队列建模，明确空、满、重复、循环或不可达边界，并能说明时间与空间复杂度。
...
请完成“栈实现进制转换”。一行给出无符号 n（0≤n≤2^63-1）和进制 b（2≤b≤36），输出大写表示。 输出只保留题目要求的结果，调试信息写入标准错误。
...
```powershell
pnpm lab:doctor -- labs/chapter-02/exercise/E-02-16-base-conversion
pnpm lab:run -- labs/chapter-02/exercise/E-02-16-base-conversion
pnpm lab:score -- labs/chapter-02/exercise/E-02-16-base-conversion
```
