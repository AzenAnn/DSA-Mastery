...
```powershell
pnpm lab:doctor -- labs/chapter-02/lab-02-10-circular-queue
pnpm lab:run -- labs/chapter-02/lab-02-10-circular-queue
pnpm lab:run -- labs/chapter-02/lab-02-10-circular-queue --case 001-sample
pnpm lab:score -- labs/chapter-02/lab-02-10-circular-queue
```
