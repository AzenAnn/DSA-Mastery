...
```powershell
pnpm lab:doctor -- labs/chapter-02/lab-02-07-queue-using-stacks
pnpm lab:run -- labs/chapter-02/lab-02-07-queue-using-stacks
pnpm lab:run -- labs/chapter-02/lab-02-07-queue-using-stacks --case 001-lazy-transfer
pnpm lab:score -- labs/chapter-02/lab-02-07-queue-using-stacks
```
