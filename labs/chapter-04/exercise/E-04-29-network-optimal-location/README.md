...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-29-network-optimal-location
pnpm lab:run -- labs/chapter-04/exercise/E-04-29-network-optimal-location
pnpm lab:run -- labs/chapter-04/exercise/E-04-29-network-optimal-location --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-29-network-optimal-location
```
