...
```powershell
# 运行评测
pnpm lab:run -- labs/chapter-04/exercise/E-04-01-complete-binary-tree-check

# 单用例调试
pnpm lab:run -- labs/chapter-04/exercise/E-04-01-complete-binary-tree-check --case 001-sample
```
