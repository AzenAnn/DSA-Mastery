---
title: "Lab 04-E-33：求根节点到叶节点数字之和"
...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-33-sum-root-to-leaf-numbers
pnpm lab:run -- labs/chapter-04/exercise/E-04-33-sum-root-to-leaf-numbers
pnpm lab:run -- labs/chapter-04/exercise/E-04-33-sum-root-to-leaf-numbers --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-33-sum-root-to-leaf-numbers
```
