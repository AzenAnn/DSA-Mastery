...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-34-binary-tree-maximum-path-sum
pnpm lab:run -- labs/chapter-04/exercise/E-04-34-binary-tree-maximum-path-sum
pnpm lab:run -- labs/chapter-04/exercise/E-04-34-binary-tree-maximum-path-sum --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-34-binary-tree-maximum-path-sum
```
