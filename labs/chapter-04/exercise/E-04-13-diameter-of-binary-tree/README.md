---
title: "Lab 04-E-13：二叉树的直径"
description: "掌握自底向上后序递归思想，通过单侧深度汇报与全局跨根路径更新计算二叉树直径。"
order: 21
chapter: 4
labId: "04E13"
chapterTitle: "树与二叉树"
...
在第 4.6.5 节中，我们学习了自底向上的递归汇总思想：二叉树的最长路径必然在某个最高节点处“拐弯”。递归函数只需向上汇报当前节点的**单侧最大深度**，在回溯时顺便计算以当前节点为最高拐弯点的**左深度与右深度之和**，即可在 $O(n)$ 时间内顺手更新出全局最大直径。
...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-13-diameter-of-binary-tree
pnpm lab:run -- labs/chapter-04/exercise/E-04-13-diameter-of-binary-tree
pnpm lab:run -- labs/chapter-04/exercise/E-04-13-diameter-of-binary-tree --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-13-diameter-of-binary-tree
```
