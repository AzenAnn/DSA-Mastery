...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-27-longest-zigzag-path
pnpm lab:run -- labs/chapter-04/exercise/E-04-27-longest-zigzag-path
pnpm lab:run -- labs/chapter-04/exercise/E-04-27-longest-zigzag-path --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-27-longest-zigzag-path
```
