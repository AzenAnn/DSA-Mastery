...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-10-binary-tree-right-side-view
pnpm lab:run -- labs/chapter-04/exercise/E-04-10-binary-tree-right-side-view
pnpm lab:run -- labs/chapter-04/exercise/E-04-10-binary-tree-right-side-view --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-10-binary-tree-right-side-view
```
