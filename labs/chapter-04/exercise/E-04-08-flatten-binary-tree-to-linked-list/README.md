...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-08-flatten-binary-tree-to-linked-list
pnpm lab:run -- labs/chapter-04/exercise/E-04-08-flatten-binary-tree-to-linked-list
pnpm lab:run -- labs/chapter-04/exercise/E-04-08-flatten-binary-tree-to-linked-list --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-08-flatten-binary-tree-to-linked-list
```
