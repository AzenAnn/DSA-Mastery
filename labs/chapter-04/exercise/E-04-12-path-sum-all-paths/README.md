---
title: "Lab 04-E-12：路径总和 II（收集所有路径）"
...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-12-path-sum-all-paths
pnpm lab:run -- labs/chapter-04/exercise/E-04-12-path-sum-all-paths
pnpm lab:run -- labs/chapter-04/exercise/E-04-12-path-sum-all-paths --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-12-path-sum-all-paths
```
