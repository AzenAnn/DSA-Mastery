...
::: tip 💡 输入提示
本题包含两行输入（主树与子树）。需引入 `<sstream>` 按行读取并分词，避免两棵树混杂：
```cpp
#include <sstream>
...
```powershell
pnpm lab:doctor -- labs/chapter-04/exercise/E-04-32-subtree-of-another-tree
pnpm lab:run -- labs/chapter-04/exercise/E-04-32-subtree-of-another-tree
pnpm lab:run -- labs/chapter-04/exercise/E-04-32-subtree-of-another-tree --case 001-sample
pnpm lab:score -- labs/chapter-04/exercise/E-04-32-subtree-of-another-tree
```
