...
```powershell
pnpm lab:doctor -- labs/chapter-04/lab-04-11-binary-tree-preorder-traversal
pnpm lab:run -- labs/chapter-04/lab-04-11-binary-tree-preorder-traversal
pnpm lab:run -- labs/chapter-04/lab-04-11-binary-tree-preorder-traversal --case 001-sample
pnpm lab:score -- labs/chapter-04/lab-04-11-binary-tree-preorder-traversal
```
