...
```powershell
pnpm lab:doctor -- labs/chapter-04/lab-04-23-binary-tree-maximum-path-sum
pnpm lab:run -- labs/chapter-04/lab-04-23-binary-tree-maximum-path-sum
pnpm lab:run -- labs/chapter-04/lab-04-23-binary-tree-maximum-path-sum --case 001-sample
pnpm lab:score -- labs/chapter-04/lab-04-23-binary-tree-maximum-path-sum
```
