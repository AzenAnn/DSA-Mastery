...
```powershell
pnpm lab:doctor -- labs/chapter-04/lab-04-15-construct-binary-tree-in-post
pnpm lab:run -- labs/chapter-04/lab-04-15-construct-binary-tree-in-post
pnpm lab:run -- labs/chapter-04/lab-04-15-construct-binary-tree-in-post --case 001-sample
pnpm lab:score -- labs/chapter-04/lab-04-15-construct-binary-tree-in-post
```
