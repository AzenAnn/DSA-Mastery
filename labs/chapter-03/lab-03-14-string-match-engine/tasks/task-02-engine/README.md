...
make score
# 免 Make 兜底（仓库根）：
pnpm lab:run -- labs/chapter-03/lab-03-14-string-match-engine --task engine
pnpm lab:score -- labs/chapter-03/lab-03-14-string-match-engine --task engine
```
