...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-17-doubly-linked-list-swap-pairs
pnpm lab:run -- labs/chapter-01/lab-01-17-doubly-linked-list-swap-pairs
pnpm lab:run -- labs/chapter-01/lab-01-17-doubly-linked-list-swap-pairs --case sample
pnpm lab:score -- labs/chapter-01/lab-01-17-doubly-linked-list-swap-pairs
```
