...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-18-josephus-problem
pnpm lab:run -- labs/chapter-01/lab-01-18-josephus-problem
pnpm lab:run -- labs/chapter-01/lab-01-18-josephus-problem --case sample
pnpm lab:score -- labs/chapter-01/lab-01-18-josephus-problem
```
