...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-18-static-linked-list-insert
pnpm lab:run -- labs/chapter-01/lab-01-18-static-linked-list-insert
pnpm lab:run -- labs/chapter-01/lab-01-18-static-linked-list-insert --case 001-sample
pnpm lab:score -- labs/chapter-01/lab-01-18-static-linked-list-insert
```
