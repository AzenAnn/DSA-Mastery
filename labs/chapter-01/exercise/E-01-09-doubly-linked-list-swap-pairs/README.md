...
```powershell
pnpm lab:doctor -- labs/chapter-01/exercise/E-01-09-doubly-linked-list-swap-pairs
pnpm lab:run -- labs/chapter-01/exercise/E-01-09-doubly-linked-list-swap-pairs
pnpm lab:run -- labs/chapter-01/exercise/E-01-09-doubly-linked-list-swap-pairs --case 001-sample
pnpm lab:score -- labs/chapter-01/exercise/E-01-09-doubly-linked-list-swap-pairs
```
