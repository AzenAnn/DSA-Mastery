...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-12-doubly-linked-list-palindrome
pnpm lab:run -- labs/chapter-01/lab-01-12-doubly-linked-list-palindrome
pnpm lab:run -- labs/chapter-01/lab-01-12-doubly-linked-list-palindrome --case 001-sample-yes
pnpm lab:score -- labs/chapter-01/lab-01-12-doubly-linked-list-palindrome
```
