...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-10-sequential-list-rotate
pnpm lab:run -- labs/chapter-01/lab-01-10-sequential-list-rotate
pnpm lab:run -- labs/chapter-01/lab-01-10-sequential-list-rotate --case sample
pnpm lab:score -- labs/chapter-01/lab-01-10-sequential-list-rotate
```
