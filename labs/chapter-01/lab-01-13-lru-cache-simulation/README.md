...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-13-lru-cache-simulation
pnpm lab:run -- labs/chapter-01/lab-01-13-lru-cache-simulation
pnpm lab:run -- labs/chapter-01/lab-01-13-lru-cache-simulation --case 001-sample
pnpm lab:score -- labs/chapter-01/lab-01-13-lru-cache-simulation
```
