...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-19-static-linked-list-reverse
pnpm lab:run -- labs/chapter-01/lab-01-19-static-linked-list-reverse
pnpm lab:run -- labs/chapter-01/lab-01-19-static-linked-list-reverse --case 001-sample
pnpm lab:score -- labs/chapter-01/lab-01-19-static-linked-list-reverse
```
