...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-12-singly-linked-list-reverse
pnpm lab:run -- labs/chapter-01/lab-01-12-singly-linked-list-reverse
pnpm lab:run -- labs/chapter-01/lab-01-12-singly-linked-list-reverse --case sample
pnpm lab:score -- labs/chapter-01/lab-01-12-singly-linked-list-reverse
```
