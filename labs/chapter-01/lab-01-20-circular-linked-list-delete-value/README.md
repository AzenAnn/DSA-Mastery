...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-20-circular-linked-list-delete-value
pnpm lab:run -- labs/chapter-01/lab-01-20-circular-linked-list-delete-value
pnpm lab:run -- labs/chapter-01/lab-01-20-circular-linked-list-delete-value --case sample
pnpm lab:score -- labs/chapter-01/lab-01-20-circular-linked-list-delete-value
```
