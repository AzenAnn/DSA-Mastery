...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-19-circular-linked-list-split
pnpm lab:run -- labs/chapter-01/lab-01-19-circular-linked-list-split
pnpm lab:run -- labs/chapter-01/lab-01-19-circular-linked-list-split --case sample
pnpm lab:score -- labs/chapter-01/lab-01-19-circular-linked-list-split
```
