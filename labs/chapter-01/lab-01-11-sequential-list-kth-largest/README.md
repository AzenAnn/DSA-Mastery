...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-11-sequential-list-kth-largest
pnpm lab:run -- labs/chapter-01/lab-01-11-sequential-list-kth-largest
pnpm lab:run -- labs/chapter-01/lab-01-11-sequential-list-kth-largest --case sample
pnpm lab:score -- labs/chapter-01/lab-01-11-sequential-list-kth-largest
```
