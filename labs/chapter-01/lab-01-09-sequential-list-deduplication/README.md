...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-09-sequential-list-deduplication
pnpm lab:run -- labs/chapter-01/lab-01-09-sequential-list-deduplication
pnpm lab:run -- labs/chapter-01/lab-01-09-sequential-list-deduplication --case sample
pnpm lab:score -- labs/chapter-01/lab-01-09-sequential-list-deduplication
```
