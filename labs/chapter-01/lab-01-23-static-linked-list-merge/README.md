...
```powershell
pnpm lab:doctor -- labs/chapter-01/lab-01-23-static-linked-list-merge
pnpm lab:run -- labs/chapter-01/lab-01-23-static-linked-list-merge
pnpm lab:run -- labs/chapter-01/lab-01-23-static-linked-list-merge --case sample
pnpm lab:score -- labs/chapter-01/lab-01-23-static-linked-list-merge
```
