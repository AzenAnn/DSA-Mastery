...
公开测试共 20 组，每组 5 分，总分 100 分。它们覆盖题面样例、单字符、全偶数、多组奇数、大小写独立计数、全部字符互异、混合频次回归，以及长度为 2000 的边界数据。
...
```bash
pnpm lab:run -- labs/chapter-13/exercise/E-13-02-longest-palindrome --target student
```
