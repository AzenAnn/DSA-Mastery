---
title: "Lab 12-E-08：快速排序"
description: "使用划分函数和递归完成原地快速排序。"
order: 10
chapter: 12
labId: "12E08"
chapterTitle: "分治与递归"
...
```powershell
cd labs/chapter-12/exercise/E-12-08-quicksort
make run
make score

# 没有 Make 时，在仓库根执行
pnpm lab:run -- labs/chapter-12/exercise/E-12-08-quicksort
pnpm lab:score -- labs/chapter-12/exercise/E-12-08-quicksort
```
