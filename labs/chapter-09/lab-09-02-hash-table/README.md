...
建议先阅读[第 9.2 节 散列表](../../../content/chapter-09-hashing-indexes/02-hash-table.md)，掌握散列函数、链地址法、开放定址法、删除标记与装填因子。
...
```powershell
pnpm lab:doctor -- labs/chapter-09/lab-09-02-hash-table
pnpm lab:run -- labs/chapter-09/lab-09-02-hash-table
pnpm lab:run -- labs/chapter-09/lab-09-02-hash-table --case 001-chaining-basic
pnpm lab:score -- labs/chapter-09/lab-09-02-hash-table
```
