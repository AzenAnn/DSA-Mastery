...
const curriculumChapterDefinitions: CurriculumChapterDefinition[] = [
  ...
  },
  {
    ...
    lessonSources: [
      "content/chapter-10-sort/05-merge-sort.md",
      "content/chapter-10-sort/06-quick-sort.md",
      "content/chapter-10-sort/07-heap-sort.md",
      "content/chapter-10-sort/08-counting-sort.md",
      "content/chapter-10-sort/09-bucket-sort.md",
      "content/chapter-10-sort/10-radix-sort.md",
    ],
