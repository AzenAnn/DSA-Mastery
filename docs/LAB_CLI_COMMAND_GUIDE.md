...
$project = "labs/chapter-04/lab-04-02-huffman-coding"
...
```powershell
pnpm lab:interactive -- labs/chapter-04/lab-04-02-huffman-coding --task frequency
```
...
make run LAB=labs/chapter-04/lab-04-02-huffman-coding TASK=frequency
make run LAB=labs/chapter-04/lab-04-02-huffman-coding TASK=frequency CASE=weighted
make run LAB=labs/chapter-04/lab-04-02-huffman-coding TASK=codec
```
...
make refresh-expected LAB=labs/chapter-04/lab-04-02-huffman-coding TASK=frequency
make refresh-expected LAB=labs/chapter-04/lab-04-02-huffman-coding TASK=frequency WRITE=1
```
...
pnpm lab:refresh-expected -- labs/chapter-04/lab-04-02-huffman-coding --task frequency
```
