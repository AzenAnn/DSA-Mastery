...
| `labs/chapter-05/lab-05-01-bfs-maze` | 旧图 BFS README-only Lab，被课程映射到 Ch.7 | `labs/chapter-07/lab-07-05-bfs-maze` | 新 Lab 保留学习成果并补齐正常、边界、错误与复盘合同；理论型 Lab 加入后重编号为 07-05 | 迁移 | 同上 |
